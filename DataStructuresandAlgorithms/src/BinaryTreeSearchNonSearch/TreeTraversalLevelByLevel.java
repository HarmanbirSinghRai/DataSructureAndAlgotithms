...
public class TreeTraversalLevelByLevel {
        ...
        while (!q1.isEmpty() || !q2.isEmpty()) {
            while (!q1.isEmpty()) {
                ...
                if (root.leftNode != null) {
                    q2.offer(root.leftNode);
                }
                if (root.rightNode != null) {
                    q2.offer(root.rightNode);
                }
            }
            System.out.println();
            while (!q2.isEmpty()) {
                ...
                System.out.print(root.iData + " ");
                if (root.leftNode != null) {
                    q1.offer(root.leftNode);
                }
                if (root.rightNode != null) {
                    q1.offer(root.rightNode);
                }
            }
            System.out.println();
        }
    ...
    public void levelByLevelOneQueueUsingDelimiter(Node root) {
        ...
        while (!q.isEmpty()) {
            ...
            if (root != null) {
                System.out.print(root.iData + " ");
                if (root.leftNode != null) {
                    q.offer(root.leftNode);
                }
                if (root.rightNode != null) {
                    q.offer(root.rightNode);
                }
            } else {
                if (!q.isEmpty()) {
                    System.out.println();
    ...
    public static void main(String args[]) {
        ...
        tt.levelByLevelTwoQueue(bst.root);
        System.out.println("\n2. One queue and delimiter");
        tt.levelByLevelOneQueueUsingDelimiter(bst.root);
        System.out.println("\n\n3. One queue and count");
        tt.levelByLevelOneQueueUsingCount(bst.root);
    }
}