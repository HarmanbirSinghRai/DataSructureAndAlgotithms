...
public class RedBlackTree {
    ...
    public void consoleUI() {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                	System.out.println("Please enter node to insert or -999 to exit");
                    item = scan.nextInt();
                    while (item != -999) {
                        node = new Node(item);
                        insert(node);
                    ...
                    break;
                case 2:
                	System.out.println("Please enter node to delete or -999 to exit");
                    item = scan.nextInt();
                    while (item != -999) {
                        node = new Node(item);
                        System.out.print("\nDeleting item " + item);
                    ...
                    break;
                case 3:
                	System.out.println("Please enter node to check or -999 to exit");
                    item = scan.nextInt();
                    while (item != -999) {
                        node = new Node(item);
